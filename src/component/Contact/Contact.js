...
export default function Contact() {
    return (
        <div id='contact' className='w-[80%] m-auto flex flex-col items-center justify-center mt-10 mb-5 '>

            <h1 className='text-4xl font-bold text-center'>Contact Us</h1>
            <p className='text-lg mt-2 font-semibold'>We'd love to hear from you!</p>

            <div className='grid md:grid-cols-2 mt-5 px-5 gap-4'>
                ...
                <div className=' w-full  md:px-10 space-y-3'>
                    <input type="text" placeholder='Name' className='w-full  border-2 border-green-500 rounded-md  outline-none p-2 ' />
                    <input type="email" placeholder='Email' className='w-full  border-2 border-green-500 rounded-md  outline-none p-2 ' />
                    <textarea cols={5} rows={5} placeholder='Write your message' className='w-full  border-2 border-green-500 rounded-md  outline-none p-2 ' />
